      ...
      body: Stack(
          ...
          Positioned(
            ...
            Positioned(
                ...
                left: 10.w,
                right: 10.w,
                child: CashData.sharedTenders==null || CashData.sharedTenders!.isEmpty? Column(
                ...
                Container(
                    ...
                    child: ListView.builder(
                      itemCount: CashData.sharedTenders!.length,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListItem(
                                  header: "رقم العملية",
                                  data: CashData.sharedTenders![index].etenderRefno,
                                ),
                                ListItem(
                                  header: "طبيعة المالية",
                                  data: CashData.sharedTenders![index].etenderTitle,
                                ),
                                ListItem(
                                  header: "الجهة",
                                  data: CashData.sharedTenders![index].blsRequestingBodyName,
                                ),
                                ListItem(
                                  header: "تاريخ فتح المظاريف",
                                  data: con.ToDate(CashData.sharedTenders![index].etenderTenderDateValue).toString(),
                                ),
                                ListItem(
